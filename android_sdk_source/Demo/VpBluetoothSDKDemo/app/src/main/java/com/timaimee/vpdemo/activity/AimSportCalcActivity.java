...
public class AimSportCalcActivity extends Activity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    private String setPersonInfo(ESex sex, float height, float weight, int stepcount) {
        ...
        String stepLength = "Stride=" + SportUtil.getStepLength(height);
        String aimTip = "Whether to use the new calculation method based on the target value calculated based on gender, height and weight=" + isnewsportcalc;
        ...
        String sportCalc = "Walking distance calculated based on gender, height, weight, steps, calories burned, steps=" + stepcount;
